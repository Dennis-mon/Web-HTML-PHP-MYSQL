...
<section class="fotos_escogida">
        ...
        <?php
            ...
            echo '<label>Dificultad: ' . $consejos[$mostrarconsejo]["Dificultad"] . '</label><br/>';
    ...
    <section id="fotos" class="fotos_principal">
        ...
        <?php
            ...
            while($fila = mysqli_fetch_assoc($resultado)) {
                if($contador < 5){
                    echo '<label>';
                        echo '<a href="detalle.php?fondo=' . $fila['IdFoto'] . '"><img src="./' . $fila['Fichero'] . '" alt="' . $fila['Alternativo'] . '" class="fotos_pagina"></a><br>';
